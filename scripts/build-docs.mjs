...
const navigationOrder = [
  ...
  "/docs/reference/rss/",
  "/docs/reference/rss/primitive-types/",
  "/docs/reference/rss/type-inference/",
  "/docs/reference/rss/bindings-and-ownership/",
  "/docs/reference/rss/collections-and-structs/",
  "/docs/reference/rss/expressions-and-operators/",
  "/docs/reference/rss/control-flow/",
  "/docs/reference/rss/functions-and-generics/",
  "/docs/reference/rss/callables-and-closures/",
  "/docs/reference/rss/modules-and-imports/",
  "/docs/reference/rss/lexical-structure/",
